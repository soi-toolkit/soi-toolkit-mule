...
public class MuleVersionEnumTest {
    ...
    public void testAllVersions() {
        assertEquals("[MULE_3_3_1_DEPRECATED, MULE_3_4_0, MULE_3_4_0_EE, MULE_3_5_0, MULE_3_6_1, MULE_3_7_0]", Arrays.asList(MuleVersionEnum.values()).toString());
    }

    @Test
    public void testNonDeprecatedVersions() {
        assertEquals("[MULE_3_4_0, MULE_3_4_0_EE, MULE_3_5_0, MULE_3_6_1, MULE_3_7_0]", MuleVersionEnum.getNonDeprecatedVersions().toString());
    }
