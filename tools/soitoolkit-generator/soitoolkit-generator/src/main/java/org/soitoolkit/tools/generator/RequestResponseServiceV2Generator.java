...
/**
 * Request-Response service generator.
 */
public class RequestResponseServiceV2Generator implements Generator {

	GeneratorUtil gu;
	IModel m;
	
	public RequestResponseServiceV2Generator(PrintStream ps, String groupId, String artifactId, String serviceName, MuleVersionEnum muleVersion, TransportEnum inboundTransport, TransportEnum outboundTransport, TransformerEnum transformerType, String outputFolder) {
		
		String templateFolder = "/requestResponseServiceV2";
	...
	public void startGenerator() {
		...
		if (transformerType.equals(TransformerEnum.JAVA)) {
			gu.generateContentAndCreateFile("src/main/java/__javaPackageFilepath__/__lowercaseJavaService__/transformer/__capitalizedJavaService__RequestTransformer.java.gt");
			gu.generateContentAndCreateFile("src/main/java/__javaPackageFilepath__/__lowercaseJavaService__/transformer/__capitalizedJavaService__ResponseTransformer.java.gt");
		
			gu.generateContentAndCreateFile("src/test/java/__javaPackageFilepath__/__lowercaseJavaService__/transformer/__capitalizedJavaService__RequestTransformerTest.java.gt");
			gu.generateContentAndCreateFile("src/test/java/__javaPackageFilepath__/__lowercaseJavaService__/transformer/__capitalizedJavaService__ResponseTransformerTest.java.gt");
		}
		...
		if (inboundTransport == TransportEnum.RESTHTTP || inboundTransport == TransportEnum.SOAPHTTP || inboundTransport == TransportEnum.HTTP || outboundTransport == RESTHTTP || outboundTransport == SOAPHTTP || outboundTransport == HTTP) {
		...
		if (inboundTransport == TransportEnum.RESTHTTPS || inboundTransport == TransportEnum.SOAPHTTPS || inboundTransport == TransportEnum.HTTPS || outboundTransport == RESTHTTPS || outboundTransport == SOAPHTTPS || outboundTransport == HTTPS) {
...
*/
	    	...
	    	cfg.println(service + "_BASE_URL=https://0.0.0.0:" + m.getHttpPort());
	    	cfg.println(service + "_BASE_PATH=/" + artifactId + "/" + serviceName + "/rest");
	    	cfg.println(service + "_SAMPLE_PATH=${" + service + "_BASE_PATH}/samples");
	    	cfg.println(service + "_INBOUND_URL=${" + service + "_BASE_URL}${" + service + "_BASE_PATH}");
	    ...
	    if (outboundTransport == SOAPHTTP) {
		    ...
		    cfg.println(service + "_TESTSTUB_INBOUND_URL=http://0.0.0.0:" + m.getHttpTeststubPort() + "/" + artifactId + "/services/" + serviceName + "-soap-teststub/v1");
	    } else if (outboundTransport == SOAPHTTPS) {
	    	cfg.println(service + "_OUTBOUND_URL=${" + service + "_TESTSTUB_INBOUND_URL}");
	    	cfg.println(service + "_TESTSTUB_INBOUND_URL=https://0.0.0.0:" + m.getHttpTeststubPort() + "/" + artifactId + "/services/" + serviceName + "-soap-teststub/v1");
	    } else if (outboundTransport == RESTHTTP) {
		    cfg.println(service + "_OUTBOUND_URL=${" + service + "_TESTSTUB_INBOUND_URL}");
		    cfg.println(service + "_TESTSTUB_INBOUND_URL=http://0.0.0.0:" + m.getHttpTeststubPort() + "/" + artifactId + "/services/" + serviceName + "-rest-teststub/v1");
	    } else if (outboundTransport == RESTHTTPS) {
	    	cfg.println(service + "_OUTBOUND_URL=${" + service + "_TESTSTUB_INBOUND_URL}");
	    	cfg.println(service + "_TESTSTUB_INBOUND_URL=https://0.0.0.0:" + m.getHttpTeststubPort() + "/" + artifactId + "/services/" + serviceName + "-rest-teststub/v1");
...
//
//		    if (inboundTransport == SOAPHTTP || inboundTransport == RESTHTTP) {
//			    cfg.println(service + "_INBOUND_URL=http://0.0.0.0:" + m.getHttpPort() + "/" + artifactId + "/services/" + serviceName + "/v1");
//		    } else if (inboundTransport == SOAPHTTPS || inboundTransport == RESTHTTPS) {
//		    	cfg.println(service + "_INBOUND_URL=https://0.0.0.0:" + m.getHttpPort() + "/" + artifactId + "/services/" + serviceName + "/v1");
//		    } else if (inboundTransport == SOAPSERVLET) {
//			    cfg.println(service + "_INBOUND_URL=servlet://" + serviceName + "/v1");
//		    }
//		    
