...
public class FileUtil {
	...
	public static PrintWriter openFileForAppend(String filename) throws IOException {
	    return new PrintWriter(new BufferedWriter(new FileWriter(filename, true)));
	}

	public static PrintWriter openFileForOverwrite(String filename) throws IOException {
