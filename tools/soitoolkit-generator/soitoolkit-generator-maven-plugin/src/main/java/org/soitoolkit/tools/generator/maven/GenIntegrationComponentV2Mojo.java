 ...
 */
public class GenIntegrationComponentV2Mojo extends AbstractMojo {
...
//		}
		...
		Generator g = new IntegrationComponentV2Generator(System.out, groupId, artifactId, version, muleVersionEnum, deployModelEnum, connectorsEnum, outDir.getPath());
